...
{
    public class ApolloSettingManager : ISettingManager
    {
        ...
        /// <inheritdoc/>
        public ApolloSettingManager(ISettingDefinitionManager settingDefinitionManager, 
